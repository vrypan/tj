...
const lifecycle_flags = [_]zecli.FlagSpec{ home_flag, keep_osc };
const use_flags = [_]zecli.FlagSpec{ home_flag, keep_osc, .{ .name = "no-replay", .description = "Start without replaying the journal" } };
