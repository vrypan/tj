...
test {
    ...
    _ = @import("protocol/scanner.zig");
    _ = @import("journal/reference.zig");
    _ = @import("terminal/altscreen.zig");
    _ = @import("presentation/plain.zig");
    _ = @import("journal/store.zig");
    _ = @import("journal/search.zig");
    _ = @import("presentation/report.zig");
    _ = @import("commands/context.zig");
    _ = @import("commands/grep.zig");
