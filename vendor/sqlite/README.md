...
both generated files together, update the artifact and checksum above,
update the version assertion in `src/journal/sqlite.zig`, and run the native
and three-target release gates.
